...
var routes = []Route{
	{
		...
		Canonical: []string{"agent status", "agent topic", "agent resume", "agent turn start", "agent turn steer", "agent turn interrupt", "agent approval review", "agent review", "agent integrate", "agent usage", "agent app-server upgrade qualify", "agent app-server upgrade plan", "agent app-server upgrade apply", "agent app-server upgrade resume", "agent app-server upgrade abort", "agent app-server handover plan", "agent app-server handover apply", "agent app-server handover resume", "agent app-server handover abort", "agent capabilities", "agent message send", "agent message status", "agent message qualify", "agent wait"},
		Children: []Route{
			...
			},
			{
				...
				Canonical:  []string{"agent app-server upgrade qualify", "agent app-server upgrade plan", "agent app-server upgrade apply", "agent app-server upgrade resume", "agent app-server upgrade abort", "agent app-server handover plan", "agent app-server handover apply", "agent app-server handover resume", "agent app-server handover abort"},
				Children: []Route{{
					Effects:    unchangedEffects(CardinalityUnchanged),
					Name:       "upgrade",
					Invocation: InvocationRefusal,
					Summary:    "Plan, apply, resume, or abort one exact rolling generation operation",
					Canonical:  []string{"agent app-server upgrade qualify", "agent app-server upgrade plan", "agent app-server upgrade apply", "agent app-server upgrade resume", "agent app-server upgrade abort"},
					Children: []Route{
						{Effects: unchangedEffects(CardinalityUnchanged), Name: "qualify", Invocation: InvocationExplicit, Summary: "Install one measured version-pair qualification receipt for the generation entry paths", Usage: []string{"projmux agent app-server upgrade qualify --receipt <absolute-json>"}, Canonical: []string{"agent app-server upgrade qualify"}},

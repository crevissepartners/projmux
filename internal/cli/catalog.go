...
var routes = []Route{
	{
		...
		Children: []Route{
			...
			},
			{
				...
				Canonical: []string{"agent message send", "agent message wait", "agent message status", "agent message qualify"},
				Children: []Route{

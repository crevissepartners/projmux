...
var flagSetNameExceptions = map[string]flagSetNameException{
	...
	`internal/app/agent_permission.go parseAgentPermissionArgs request.spelling`:                      {routes: []string{"agent approval list", "agent approval answer"}, reason: flagSetNameDynamicReason},

...
var settingsNodeCatalog = []settingsNavNode{
	...
	{ID: settingsNavAbout + ".updates.channel", Parent: settingsNavAbout + ".updates", Label: "Release channel", LabelKey: "settings.text.release_channel", Kind: settingsNavToggle, Axis: settingsAxisGlobal, Value: settingsUpdateReleaseChannel, Owner: settingsOwnerAbout, Note: "off by default; opt-in to the rc release channel"},

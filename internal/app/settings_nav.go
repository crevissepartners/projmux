...
var settingsNavCatalog = []settingsNavNode{
	...
	{ID: settingsNavStatusBar + ".agent-usage-hud", Parent: settingsNavStatusBar, Label: "Agent Usage HUD", Kind: settingsNavView, Axis: settingsAxisGlobal, Value: settingsAppearanceAgentUsageHUD, Note: "agent usage source / preview badge"},

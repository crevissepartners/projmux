...
func TestPublicRoutesLeftoverArgsAndUnknownSubcommandsAreUsageErrors(t *testing.T) {
	...
	for _, test := range []struct {
		...
		// pin project
		{name: "pin project D", argv: []string{"pin", "project"}, want: "pin requires a subcommand"},
		{name: "pin project B", argv: []string{"pin", "project", "x", "--zz"}, want: "unknown pin subcommand: x"},
		{name: "pin project C", argv: []string{"pin", "project", "x"}, want: "unknown pin subcommand: x"},
		{name: "pin project project", argv: []string{"pin", "project", "project"}, want: "unknown pin project subcommand: project"},
		{name: "pin project list positional", argv: []string{"pin", "project", "list", "x"}, want: "pin list does not accept positional arguments"},
		{name: "pin project clear positional", argv: []string{"pin", "project", "clear", "x"}, want: "pin clear does not accept positional arguments"},
		{name: "pin project migrate positional", argv: []string{"pin", "project", "migrate", "x"}, want: "pin migrate does not accept positional arguments"},
		// quit
		...
		// runtime
		{name: "runtime sessions B", argv: []string{"runtime", "sessions", "x", "--zz"}, want: "sessions does not accept positional arguments"},
		{name: "runtime sessions C", argv: []string{"runtime", "sessions", "x"}, want: "sessions does not accept positional arguments"},
		{name: "runtime attach B", argv: []string{"runtime", "attach", "x", "--zz"}, want: "attach auto does not accept positional arguments"},
		{name: "runtime attach C", argv: []string{"runtime", "attach", "x"}, want: "attach auto does not accept positional arguments"},
		{name: "runtime tag B", argv: []string{"runtime", "tag", "x", "--zz"}, want: "unknown tag subcommand: x"},
		{name: "runtime tag C", argv: []string{"runtime", "tag", "x"}, want: "unknown tag subcommand: x"},
		{name: "runtime tag project project", argv: []string{"runtime", "tag", "project", "project"}, want: "unknown tag project subcommand: project"},
		{name: "runtime tag list positional", argv: []string{"runtime", "tag", "list", "x"}, want: "tag list does not accept positional arguments"},
		{name: "runtime tag clear positional", argv: []string{"runtime", "tag", "clear", "x"}, want: "tag clear does not accept positional arguments"},
		{name: "runtime prune B", argv: []string{"runtime", "prune", "x", "--zz"}, want: "prune ephemeral does not accept positional arguments"},
		{name: "runtime prune C", argv: []string{"runtime", "prune", "x"}, want: "prune ephemeral does not accept positional arguments"},

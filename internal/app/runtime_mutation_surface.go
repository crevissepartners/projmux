...
var runtimeMutationSurfaces = []runtimeMutationSurface{
	...
	typedExemptSurface("agent.presentation", "Agent topic/interaction projection", "typed controller and provider lifecycle presentation adapters", "presentation", "Project|ControlSession", "exact Agent Pane UID, activation, and containment", mutationWritePresentationOption, "closed topic/manual-topic/state/badge/attention field grammar; UID/topology unchanged", "Agent presentation changes through guarded typed or exact native provider projection"),

...
var runtimeMutationSurfaces = []runtimeMutationSurface{
	...
	plannedSurface("resource.rename-window", "public resource rename Window", "renameRuntimeWindow", "managed stable identity", "Project|ControlSession", "Registry Window UID and exact runtime Window handle", mutationWriteIdentity, "exact route, root UID and Window containment", "Window stable-name mirror changes; display name, UID, and topology remain"),

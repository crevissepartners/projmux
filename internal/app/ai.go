...
func printAIUsage(w io.Writer) {
	...
	fmt.Fprintln(w, "  projmux create agent --provider <claude|codex|antigravity> [--placement right|down] [-o pane-id|none] [-- <extra-arg>...]")
	fmt.Fprintln(w, "  projmux create pane [--placement right|down] [-o pane-id|none]")

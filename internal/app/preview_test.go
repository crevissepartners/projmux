...
func TestTmuxPreviewInventoryMapsPaneMetadata(t *testing.T) {
	...
	inventory := tmuxPreviewInventory{
		client: stubTmuxPreviewInventoryClient{
			panes: []inttmux.Pane{
				{ID: "%1", SessionName: "dev", WindowIndex: 2, PaneIndex: 1, Title: "server", Label: "api label", AttentionState: "busy", AIState: "thinking", AIBadgeKind: "approval_required", AIAgent: "codex", AITopic: "approval needed", AttentionAck: "1", AttentionFocusArmed: "1", Command: "go", Path: "/repo/dev", Active: true},
	...
	want := []corepreview.Pane{
		{ID: "%1", SessionName: "dev", WindowIndex: "2", Index: "1", Title: "server", Label: "api label", AttentionState: "busy", AIState: "thinking", AIBadgeKind: "approval_required", AIAgent: "codex", AITopic: "approval needed", AttentionAck: "1", AttentionFocusArmed: "1", Command: "go", Path: "/repo/dev", Active: true},
	}

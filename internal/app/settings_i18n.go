...
var uiTextKeys = map[string]i18n.Key{
	...
	"Recreate Project": "settings.text.project_startup_fresh",
	"replace this Project identity with a new Project, Window, and shell":                                                           "settings.text.project_startup_fresh_description",
	...
	"Continue project / Recreate Project":                                                                                           "settings.text.project_startup_choices",
	"keep this Project identity; restore saved Windows, shell Panes, and Agents, or create a new Window and shell when none remain": "settings.desc.project_startup_continue",
	"Enter: open  |  Esc: projects":                                                                                                 "settings.footer.project_startup",
	"Enter: confirm  |  Esc: back":                                                                                                  "settings.footer.project_recreate_confirm",
	"Keep this Project":                                                                                                             "settings.text.project_recreate_cancel",
	"keep this Project identity and return to the startup screen":                                                                   "settings.desc.project_recreate_cancel",
	"replace this Project identity; the old graph is removed":                                                                       "settings.desc.project_recreate_confirm",
	"closed Project startup: show Continue project and Recreate Project":                                                            "settings.desc.closed_startup_choices",
	"closed Project startup: Continue project":                                                                                      "settings.desc.closed_startup_continue",
	"show Continue project and Recreate Project for a closed Project":                                                               "settings.desc.closed_startup_show_choices",
	"Project %s snapshot projection: replace Window %d / Pane %d / Agent %d; delete Window %d / Pane %d / Agent %d; preserve uid %d; lose conversation pointer %d; trust Project open gate pending; snapshot startup command execution 0; Registry writes 0 / tmux writes 0 / snapshot writes 0\n": "settings.result.snapshot_projection_preview",
	"projmux: snapshot desired state was committed; runtime item was refused: ordinary Project materializer is not configured":                                                                                                                                                                     "settings.notice.snapshot_projection_materializer_missing",
	"restored snapshot into Project %s: Window %d / Pane %d / Agent %d, preserved uid %d\n":                                                                                                                                                                                                        "settings.result.snapshot_projection_committed",
	"projmux: snapshot desired state was committed; runtime item was refused: %s":                                                                                                                                                                                                                  "settings.notice.snapshot_projection_runtime_refused",
	"restore snapshot committed desired Registry; runtime materialization needs another Continue project":                                                                                                                                                                                          "settings.error.snapshot_projection_runtime_refused",
	...
	"Recreate Project > ":                                      "settings.prompt.project_recreate_confirm",
	...
	"personality":                        "picker.ai.codex_capability_personality",

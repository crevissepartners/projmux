...
var uiTextKeys = map[string]i18n.Key{
	...
	"Open fresh":       "settings.text.project_startup_fresh",
	...
	"Continue project / Open fresh": "settings.text.project_startup_choices",
	...
	"closed Project startup: show Continue project and Open fresh": "settings.desc.closed_startup_choices",
	"closed Project startup: Continue project":                     "settings.desc.closed_startup_continue",
	"show Continue project and Open fresh for a closed Project":    "settings.desc.closed_startup_show_choices",

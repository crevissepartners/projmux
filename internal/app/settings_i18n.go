...
var uiTextKeys = map[string]i18n.Key{
	...
	"open a new Project identity with one canonical shell":                     "settings.text.project_startup_fresh_description",
	"projmux: opened %s fresh with a new Project identity and canonical shell": "settings.notice.project_startup_fresh_identity",

...
var uiTextKeys = map[string]i18n.Key{
	...
	"pinned Registry Projects, by UID":                   "settings.desc.pinned_projects",
	"pinned paths no Registry Project claims":            "settings.desc.candidate_pins",
	"not registered as a Project resource":               "settings.desc.candidate_not_registered",
	"no Registry Project claims this path":               "settings.desc.candidate_registration_none",
	"candidate preference, not managed identity":         "settings.desc.candidate_path",
	"registers this exact path only":                     "settings.desc.candidate_register",
	"removes the pin; the directory is untouched":        "settings.desc.unpin_candidate",
	"pinned UID with no Registry Project":                "settings.desc.pin_uid_unregistered",
	"unavailable - no Registry Project carries this UID": "settings.desc.rebind_unavailable_uid",
	"Candidate Pins":                                    "settings.text.candidate_pins",
	"Register as Project":                               "settings.text.register_as_project",
	"Unpin candidate":                                   "settings.text.unpin_candidate",
	"Path / Registration":                               "settings.text.candidate_state_row",
	...
	"Continue project":      "settings.text.project_startup_continue",
	"Clear layout and open": "settings.text.project_startup_fresh",
	"clear the saved Window and Agent layout and open again; the folder, its files, .projmux/config.toml, and trust stay":                            "settings.text.project_startup_fresh_description",
	"projmux: opened %s fresh; old Project UID %s -> new Project UID %s; stage=materialized":                                                         "settings.notice.project_startup_fresh_identity",
	"keep this Project identity; open the Windows, shell Panes, and Agents the Registry declares, or create a new Window and shell when none remain": "settings.desc.project_startup_continue",
	"Enter: open  |  Esc: projects":                                                                "settings.footer.project_startup",
	"Enter: confirm  |  Esc: back":                                                                 "settings.footer.project_recreate_confirm",
	"Keep the saved layout":                                                                        "settings.text.project_recreate_cancel",
	"keep the saved layout and return to the startup screen":                                       "settings.desc.project_recreate_cancel",
	"clear the saved Window and Agent layout; the folder and its files stay":                       "settings.desc.project_recreate_confirm",
	"Stop Project Runtime (keep UID/topology)":                                                     "settings.text.stop_project_runtime_preserve_identity",
	"Stop only the focused Project runtime; keep its Project UID and desired Window/Pane topology": "settings.desc.stop_project_runtime_preserve_identity",
	"stop only the Project runtime; keep its Project UID and desired Window/Pane topology":         "settings.desc.stop_project_runtime_preserve_identity_lower",
	"Stop Runtime Session (keep managed identity)":                                                 "settings.text.stop_session_preserve_identity",
	"Stop only the focused runtime Session; keep managed Registry identity and desired topology":   "settings.desc.stop_session_preserve_identity",
	"stop only the runtime Session; keep managed Registry identity and desired topology":           "settings.desc.stop_session_preserve_identity_lower",
	...
	"When needed":                        "settings.text.runtime_diagnostics_when_needed",
	"Always":                             "settings.text.runtime_diagnostics_always",
	"invalid saved value; using default": "settings.text.invalid_saved_value_default",
	"show the Runtime row only for a refused class or an observation that could not be taken": "settings.desc.runtime_diagnostics_when_needed",
	"show the Runtime row on every render, before Settings":                                   "settings.desc.runtime_diagnostics_always",
	"Use Project topology":        "settings.text.use_project_topology",
	"Project topology":            "settings.text.project_topology_row",
	...
	"Projects - Runtime diagnostics":                                "settings.title.projects_runtime_diagnostics",
	...
	"Settings > Projects > Project Sidebar > Runtime diagnostics > ":   "settings.prompt.settings_projects_runtime_diagnostics",
	...
	"Clear layout and open > ":                                 "settings.prompt.project_recreate_confirm",
	...
	"Enter: save  |  Example: 900":                                               "settings.footer.enter_save_example_900",
	...
	"stop runtime; keep Project UID/topology": "picker.switch.action.stop_project_runtime_preserve_identity",
	...
	"Untitled":                                 "picker.ai.resume_untitled",
	"Conversation ID":                          "picker.ai.resume_detail_id",
	"Details":                                  "picker.ai.resume_detail_metadata",
	"available":                                "picker.ai.resume_available",
	"empty":                                    "picker.ai.resume_empty",
	"fallback":                                 "picker.ai.resume_fallback",
	"available · no conversations":             "picker.ai.resume_available_empty",
	"loading…":                                 "picker.ai.resume_provider_loading",

	"Select a resume session to see details.": i18n.KeyPickerResumeDetailHelp,
	"Turns":      i18n.KeyPickerResumeDetailTurns,
	"Confidence": i18n.KeyPickerResumeDetailConfidence,
	"Reason":     i18n.KeyPickerResumeDetailReason,

	"Read-only hook":      "picker.hook.read_only_hook",
	"Projects":            "picker.crumb.projects",
	"Runtime diagnostics": "picker.runtime.title",
	"Runtime object":      "picker.runtime.object_label",
	"Focus":               "picker.runtime.action_focus",
	"Attach":              "picker.runtime.action_attach",
	"unavailable - the containing session was not observed, so there is no exact coordinate": "picker.runtime.focus_no_coordinate",
	"unavailable - the exact socket path could not be read from the server":                  "picker.runtime.focus_no_socket",
	"unavailable - only a session projects a Project runtime":                                "picker.runtime.attach_not_session",
	"unavailable - no Registry Project claims this session; diagnostics never adopts one":    "picker.runtime.attach_unmanaged",
	"unavailable - already inside a tmux client; use Focus instead":                          "picker.runtime.attach_inside_tmux",
	...
	"Agent questions":                                  "settings.text.agent_questions",
	"Answering":                                        "settings.text.agent_question_answering_row",
	"Wait window":                                      "settings.text.agent_question_window_row",
	"One Agent":                                        "settings.text.agent_questions_per_agent",
	"AI - Agent questions":                             "settings.title.ai_agent_questions",
	"AI - Answering":                                   "settings.title.ai_agent_question_answering",
	"AI - Wait window":                                 "settings.title.ai_agent_question_window",
	"AI - Custom wait window":                          "settings.title.ai_agent_question_window_custom",
	"Settings > AI > Agent questions > ":               "settings.prompt.settings_ai_agent_questions",
	"Settings > AI > Agent questions > Answering > ":   "settings.prompt.settings_ai_agent_question_answering",
	"Settings > AI > Agent questions > Wait window > ": "settings.prompt.settings_ai_agent_question_window",
	"Wait window seconds > ":                           "settings.prompt.agent_question_window_seconds",
	"store 60 to 3600 seconds":                         "settings.desc.agent_question_window_custom",

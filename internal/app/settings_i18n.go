...
var uiTextKeys = map[string]i18n.Key{
	...
	"open every saved Window, shell Pane, and Agent":                                        "settings.desc.project_startup_continue",
	"keep the canonical Project shell and remove every other saved Window, Pane, and Agent": "settings.desc.project_startup_fresh",
	"Enter: open  |  Esc: projects":                                                         "settings.footer.project_startup",
	"Open fresh: prune saved topology?":                                                     "settings.title.project_startup_fresh_confirm",
	"Open fresh > ":                                                                         "settings.prompt.project_startup_fresh_confirm",
	"Yes, prune and open fresh":                                                             "settings.text.project_startup_fresh_confirm",
	...
	"deletes %s; the canonical Project Window and shell Pane, snapshots, Project registration, managed root, and trust decision are kept": "settings.desc.project_startup_fresh_scope",
	"deletes %s; no Agent record remains, so no Agent conversation pointer status.sessionRef is lost":                                     "settings.desc.project_startup_fresh_no_pointer_loss",
	"deletes %s; the Agents' conversation pointer status.sessionRef (%d recorded) is deleted with them and cannot be recovered":           "settings.desc.project_startup_fresh_pointer_loss",
	"projmux: opened %s fresh: deleted %s; the canonical Project shell identity was preserved":                                            "settings.notice.project_startup_fresh_complete",
	"projmux: Open fresh canceled; nothing was changed":                                                                                   "settings.notice.project_startup_fresh_canceled",
	"projmux: fresh start confirmation could not be shown: %s":                                                                            "settings.notice.project_startup_fresh_confirm_error",

...
var uiTextKeys = map[string]i18n.Key{
	...
	"reuse the canonical Project Window with one shell":                    "settings.text.project_startup_fresh_description",
	"projmux: opened %s fresh with its canonical Project Window and shell": "settings.notice.project_startup_fresh_identity",

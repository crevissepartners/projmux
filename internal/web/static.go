...
// /project/x/window/y/pane/z. The uids themselves are not checked here; the
// client asks the API, which reports a miss.
func isClientPath(path string) bool {
	...
	case 6:
		return parts[0] == "project" && parts[2] == "window" && parts[4] == "pane"
	}
	return false
}

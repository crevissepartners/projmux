...
var commandRules = map[string]commandRule{
	...
	"agent":           {subcommands: stringSet("status", "topic", "resume", "instructions", "persona", "turn", "approval", "review", "integrate", "usage", "capabilities", "models", "message", "wait", "question", "sessions")},
	"config":          {subcommands: stringSet("edit", "providers", "locale", "agent-questions", "agent-approvals", "render", "apply")},

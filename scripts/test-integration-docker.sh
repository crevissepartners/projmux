...
"$root/scripts/test-docker-run.sh" test/integration/reconcile-ended-session-live-flag.sh "$@"
"$root/scripts/test-docker-run.sh" test/integration/reconcile-absent-server-live-flag.sh "$@"
"$root/scripts/test-docker-run.sh" test/integration/hook-ended-session-live-flag.sh "$@"
"$root/scripts/test-docker-run.sh" test/integration/cross-server-live-flag.sh "$@"

...
names=['agent-dialogue-live-canary.sh','agent-dialogue-canary-setup.py','agent-dialogue-canary-evidence.py',
       'agent-dialogue-source-action.py','agent-dialogue-codex-observation.py','agent-dialogue-native-source.py','agent-dialogue-native-policy.py','agent-dialogue-websocket.py']

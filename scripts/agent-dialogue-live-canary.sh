...
sender_pane_uid="$(field sender.paneUID)"
sender_pane_id="$(field sender.paneID)"
sender_generation="$(field sender.generation)"
receiver_uid="$(field receiver.agentUID)"
receiver_pane_uid="$(field receiver.paneUID)"
receiver_pane_id="$(field receiver.paneID)"
receiver_generation="$(field receiver.generation)"

...
- Mouse support is intentionally narrow in this POC: primary click focuses a
  row and wheel input moves selection. Double-click accept, drag gestures, and
  the full fzf mouse grammar are follow-up work.

...
- `make test`: fast unit coverage for app-layer current, kill, pin, and switch commands, switch row rendering, session identity, candidate discovery, config path derivation, and pure state rules.

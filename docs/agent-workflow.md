...
- `make test` also covers Settings > Session State view-first rows, auto-save/auto-restore toggles, current-session snapshot summary/delete behavior, and the autosave disabled gate.

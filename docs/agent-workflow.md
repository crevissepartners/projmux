...
- `make test`: fast unit coverage for core packages such as session identity, current-command path-to-session wiring, sanitization, config path derivation, and pure state rules.
